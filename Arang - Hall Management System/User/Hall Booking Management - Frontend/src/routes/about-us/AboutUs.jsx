  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <p className="text-lg mb-8">
        Welcome to <span className="text-brand">Arang</span>, where we are
        dedicated to providing you with the best experience for booking Halls
      ...
      <p className="text-lg mb-8">
        At <span className="text-brand">Arang</span>, we envision a world
      ...
      <ul className="list-disc ml-6 mb-8">
        <li className="text-lg mb-3">
          We offer a diverse range of Halls, from luxury resorts to cozy
      ...
      <p className="text-lg">
        Thank you for choosing <span className="text-brand">Arang</span>.
